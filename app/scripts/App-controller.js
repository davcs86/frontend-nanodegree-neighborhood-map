...
(function () {
    ...
    AppController.$inject = ['$timeout', '$mdSidenav', '$q', '$localStorage', 'NgMap', 'locationsFactory', '$log'];
    function AppController ($timeout, $mdSidenav, $q, $localStorage, NgMap, locationsFactory, $log) {
        var vm = this;
